...
/**
 * Pointer to the K-Nearest Neighbors classifier.
 */
extern cv::Ptr<cv::ml::KNearest>  kNearest;

// function prototypes //////////////////////////////////////////////////
/**
 * Load the KNN data and train the KNN classifier.
 * @return True if successful, false otherwise.
 */

bool loadKNNDataAndTrainKNN(void);
/**
 * Detect and recognize characters in a vector of possible plates.
 * @param vectorOfPossiblePlates The vector of possible plates.
 * @return The vector of possible plates with recognized characters.
 */

std::vector<PossiblePlate> CharDetectionInPlates(std::vector<PossiblePlate> &vectorOfPossiblePlates);
/**
 * Find and return a vector of possible characters in a plate image.
 * @param imgGrayscale The grayscale plate image.
 * @param imgThresh The thresholded plate image.
 * @return The vector of possible characters.
 */

std::vector<PossibleChar> findPossibleCharsInPlate(cv::Mat &imgGrayscale, cv::Mat &imgThresh);

/**
 * Check if a possible character satisfies the criteria for a valid character.
 * @param possibleChar The possible character to check.
...
/**
 * Find and return a vector of vectors of matching characters.
 * @param vectorOfPossibleChars The vector of possible characters.
 * @return The vector of vectors of matching characters
 */
